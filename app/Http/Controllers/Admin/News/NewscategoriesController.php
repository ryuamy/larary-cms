...
class NewscategoriesController extends Controller
{
    ...
    public function index()
    {
        ...
        $datas_list = Categories::where('deleted_at', NULL)->where('type', 1);
    ...
    public function save(Request $request)
    {
        ...
        $new_data = Categories::where('deleted_at', NULL)->whereRaw('name = "'.$request->input('title').'"')->orderByRaw('id desc')->first();
        ...
        insert_admin_logs(
            ...
            $new_data->id,
            'INSERT',
            'Create news categories with title '.$new_data->name
        );
