...
class AdminsController extends Controller
{
    ...
    {
        $this->validationRules['email'] = 'required|email|unique:admins,email';
    ...
    {
        $current = Admins::where('uuid', $uuid)
            ->with(
    ...
    public function update($uuid, Request $request)
    {
        ...
        $this->validationRules['email'] = 'required|email|unique:admins,email,'.$uuid.',uuid';
        $this->validationMessages['email.unique'] = 'Email already used or registered.';
