...
var KTPages = function () {
    ...
    // basic demo
    var _demo = function () {
        var datatable = $('#kt_data_pages').KTDatatable({
        ...
        $('#kt_data_pages_search_status').on('change', function () {
        ...
        $('#kt_data_pages_search_status, #kt_datatable_search_type').selectpicker();
    };
