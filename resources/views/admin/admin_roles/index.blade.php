                            ...
                            <?php if(count($list) > 0) { ?>
                                <?php foreach($list as $dt) { ?>
                                    <tr>
                                        @if ( check_admin_access($admindata->role_id, $staticdata['module_slug'], 'edit') == true )
                                            <td>
                                                <label class="checkbox checkbox-lg checkbox-inline {{ $dt['id'] === 1 || $dt['id'] === 2 || $dt['id'] === 3 ? 'checkbox-disabled' : '' }}">
                                                    <input type="checkbox" value="{{ $dt['uuid'] }}" name="bulk[]" class="{{ $dt['id'] === 1 || $dt['id'] === 2 || $dt['id'] === 3 ? '' : 'bulk_action_list' }}" 
                                                        {{ $dt['id'] === 1 || $dt['id'] === 2 || $dt['id'] === 3 ? 'disabled' : '' }}
                                                    />
                                                    <span></span>
                                                </label>
                                            </td>
