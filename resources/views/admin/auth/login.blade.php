...
<html lang="en">
	...
	>
				...
				>
					<div class="login-form text-center p-7 position-relative overflow-hidden">
						...
						<?php /*<div class="d-flex flex-center mb-15">
							<a href="#">
								<img src="{{ asset('/media/metronic_v7.1.2/media/logos/logo-letter-13.png') }}" 
		...
		<script src="{{ asset('/ja/global/metronic_v7.1.2/plugins/custom/prismjs/prismjs.bundle.js') }}"></script>
