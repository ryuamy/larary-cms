                ...
                <div class="d-flex">
                    <div class="flex-shrink-0 mr-7">
                        <div class="symbol symbol-50 symbol-lg-120">
                            <img alt="Pic" src="{{ asset('/metronic_v7.1.2/media/users/300_1.jpg') }}" />
                        </div>
                    </div>
        ...
        <div class="card card-custom gutter-b">
            <div class="card-body">
                ...
                <div class="d-flex">
                    ...
                    <div class="flex-shrink-0 mr-7">
                        <div class="symbol symbol-50 symbol-lg-120">
                            <img alt="Pic" src="{{ asset('/metronic_v7.1.2/media//users/300_10.jpg') }}" />
                        </div>
                    </div>
                    <!--end::Pic-->
                    <!--begin: Info-->
