...
<html lang="en">
	<head><base href="">
		...
		<link href="{{ asset('/metronic_v7.1.2/plugins/custom/fullcalendar/fullcalendar.bundle.css') }}" rel="stylesheet" type="text/css" />        
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
							...
							<div class="topbar">
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
										<form>
											<!--begin::Header-->
											<div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url({{ asset('/metronic_v7.1.2/media/misc/bg-1.jpg') }})">
												<!--begin::Title-->
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
										<!--begin:Header-->
										<div class="d-flex flex-column flex-center py-10 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url({{ asset('/metronic_v7.1.2/media/misc/bg-1.jpg') }})">
								...
								<div class="dropdown">
									...
									<div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
										<div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
											<img class="h-20px w-20px rounded-sm" src="{{ asset('/metronic_v7.1.2/media/svg/flags/226-united-states.svg') }}" alt="" />
										</div>
									</div>
									<!--end::Toggle-->
									<!--begin::Dropdown-->
									<div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
										...
										<ul class="navi navi-hover py-4">
											...
											<li class="navi-item">
												<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="{{ asset('/metronic_v7.1.2/media/svg/flags/226-united-states.svg') }}" alt="" />
													</span>
											...
											<li class="navi-item active">
												<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="{{ asset('/metronic_v7.1.2/media/svg/flags/128-spain.svg') }}" alt="" />
													</span>
											...
											<li class="navi-item">
												<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="{{ asset('/metronic_v7.1.2/media/svg/flags/162-germany.svg') }}" alt="" />
													</span>
											...
											<li class="navi-item">
												<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="{{ asset('/metronic_v7.1.2/media/svg/flags/063-japan.svg') }}" alt="" />
													</span>
											...
											<li class="navi-item">
												<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="{{ asset('/metronic_v7.1.2/media/svg/flags/195-france.svg') }}" alt="" />
													</span>
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						<div class="symbol-label" style="background-image:url('{{ asset('/metronic_v7.1.2/media/users/300_21.jpg') }}')"></div>
				...
				<div class="navi navi-spacer-x-0 p-0">
					<!--begin::Item-->
					<a href="custom/apps/user/profile-1/personal-information" class="navi-item">
						<div class="navi-link">
					...
					<!--end:Item-->
					<!--begin::Item-->
					<a href="custom/apps/user/profile-3" class="navi-item">
						<div class="navi-link">
							<div class="symbol symbol-40 bg-light mr-3">
								<div class="symbol-label">
					...
					<!--end:Item-->
					<!--begin::Item-->
					<a href="custom/apps/user/profile-2" class="navi-item">
						<div class="navi-link">
							<div class="symbol symbol-40 bg-light mr-3">
								<div class="symbol-label">
					...
					<!--end:Item-->
					<!--begin::Item-->
					<a href="custom/apps/userprofile-1/overview" class="navi-item">
						<div class="navi-link">
							<div class="symbol symbol-40 bg-light mr-3">
								<div class="symbol-label">
				...
				<div class="offcanvas-wrapper mb-5 scroll-pull">
					...
					<div class="d-flex align-items-center justify-content-between py-8">
						...
						<a href="#" class="symbol symbol-70 flex-shrink-0">
							<img src="{{ asset('/metronic_v7.1.2/media/stock-600x400/img-1.jpg') }}" title="" alt="" />
						</a>
					</div>
					<!--end::Item-->
					<!--begin::Separator-->
					...
					<div class="d-flex align-items-center justify-content-between py-8">
						...
						<a href="#" class="symbol symbol-70 flex-shrink-0">
							<img src="{{ asset('/metronic_v7.1.2/media/stock-600x400/img-2.jpg') }}" title="" alt="" />
						</a>
					</div>
					<!--end::Item-->
					<!--begin::Separator-->
					...
					<div class="d-flex align-items-center justify-content-between py-8">
						...
						<a href="#" class="symbol symbol-70 flex-shrink-0">
							<img src="{{ asset('/metronic_v7.1.2/media/stock-600x400/img-3.jpg') }}" title="" alt="" />
						</a>
					</div>
					<!--end::Item-->
					<!--begin::Separator-->
					...
					<div class="d-flex align-items-center justify-content-between py-8">
						...
						<a href="#" class="symbol symbol-70 flex-shrink-0">
							<img src="{{ asset('/metronic_v7.1.2/media/stock-600x400/img-4.jpg') }}" title="" alt="" />
						</a>
					</div>
					<!--end::Item-->
					<!--begin::Separator-->
					...
					<div class="d-flex align-items-center justify-content-between py-8">
						...
						<a href="#" class="symbol symbol-70 flex-shrink-0">
							<img src="{{ asset('/metronic_v7.1.2/media/stock-600x400/img-8.jpg') }}" title="" alt="" />
						</a>
					</div>
					<!--end::Item-->
				</div>
						...
						<div class="mb-15">
							...
							<div class="d-flex align-items-center flex-wrap mb-5">
								<div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img src="{{ asset('/metronic_v7.1.2/media/svg/misc/006-plurk.svg') }}" class="h-50 align-self-center" alt="" />
									</span>
								</div>
								<div class="d-flex flex-column flex-grow-1 mr-2">
							...
							<div class="d-flex align-items-center flex-wrap mb-5">
								<div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img src="{{ asset('/metronic_v7.1.2/media/svg/misc/015-telegram.svg') }}" class="h-50 align-self-center" alt="" />
									</span>
								</div>
								<div class="d-flex flex-column flex-grow-1 mr-2">
							...
							<div class="d-flex align-items-center flex-wrap mb-5">
								<div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img src="{{ asset('/metronic_v7.1.2/media/svg/misc/003-puzzle.svg') }}" class="h-50 align-self-center" alt="" />
									</span>
								</div>
								<div class="d-flex flex-column flex-grow-1 mr-2">
							...
							<div class="d-flex align-items-center flex-wrap mb-5">
								<div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img src="{{ asset('/metronic_v7.1.2/media/svg/misc/005-bebo.svg') }}" class="h-50 align-self-center" alt="" />
									</span>
								</div>
								<div class="d-flex flex-column flex-grow-1 mr-2">
							...
							<div class="d-flex align-items-center flex-wrap">
								<div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img src="{{ asset('/metronic_v7.1.2/media/svg/misc/014-kickstarter.svg') }}" class="h-50 align-self-center" alt="" />
									</span>
								</div>
								<div class="d-flex flex-column flex-grow-1 mr-2">
		...
		<ul class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4">
			...
			<li class="nav-item mb-2" data-toggle="tooltip" title="Layout Builder" data-placement="left">
				<a class="btn btn-sm btn-icon btn-bg-light btn-icon-primary btn-hover-primary" href="https://preview.keenthemes.com/metronic/demo1/builder" target="_blank">
					<i class="flaticon2-gear"></i>
				</a>
			</li>
			<!--end::Item-->
				...
				<div class="offcanvas-wrapper mb-5 scroll-pull">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo1.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							...
							<a href="https://preview.keenthemes.com/metronic/demo1/rtl/index" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">RTL Version</a>
						</div>
					</div>
					<h5 class="font-weight-bold mb-4 text-center">Demo 2</h5>
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo2.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							...
							<a href="https://preview.keenthemes.com/metronic/demo2/rtl/index" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">RTL Version</a>
						</div>
					</div>
					<h5 class="font-weight-bold mb-4 text-center">Demo 3</h5>
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo3.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							...
							<a href="https://preview.keenthemes.com/metronic/demo3/rtl/index" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">RTL Version</a>
						</div>
					</div>
					<h5 class="font-weight-bold mb-4 text-center">Demo 4</h5>
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo4.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							...
							<a href="https://preview.keenthemes.com/metronic/demo4/rtl/index" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">RTL Version</a>
						</div>
					</div>
					<h5 class="font-weight-bold mb-4 text-center">Demo 5</h5>
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo5.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							...
							<a href="https://preview.keenthemes.com/metronic/demo5/rtl/index" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">RTL Version</a>
						</div>
					</div>
					<h5 class="font-weight-bold mb-4 text-center">Demo 6</h5>
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo6.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							...
							<a href="https://preview.keenthemes.com/metronic/demo6/rtl/index" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">RTL Version</a>
						</div>
					</div>
					<h5 class="font-weight-bold mb-4 text-center">Demo 7</h5>
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo7.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							...
							<a href="https://preview.keenthemes.com/metronic/demo7/rtl/index" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">RTL Version</a>
						</div>
					</div>
					<h5 class="font-weight-bold mb-4 text-center">Demo 8</h5>
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo8.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							...
							<a href="https://preview.keenthemes.com/metronic/demo8/rtl/index" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">RTL Version</a>
						</div>
					</div>
					<h5 class="font-weight-bold mb-4 text-center">Demo 9</h5>
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo9.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							...
							<a href="https://preview.keenthemes.com/metronic/demo9/rtl/index" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">RTL Version</a>
						</div>
					</div>
					<h5 class="font-weight-bold mb-4 text-center">Demo 10</h5>
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo10.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							...
							<a href="https://preview.keenthemes.com/metronic/demo10/rtl/index" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">RTL Version</a>
						</div>
					</div>
					<h5 class="font-weight-bold mb-4 text-center">Demo 11</h5>
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo11.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							...
							<a href="https://preview.keenthemes.com/metronic/demo11/rtl/index" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">RTL Version</a>
						</div>
					</div>
					<h5 class="font-weight-bold mb-4 text-center">Demo 12</h5>
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo12.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							...
							<a href="https://preview.keenthemes.com/metronic/demo12/rtl/index" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">RTL Version</a>
						</div>
					</div>
					<h5 class="font-weight-bold mb-4 text-center">Demo 13</h5>
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo13.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							...
							<a href="https://preview.keenthemes.com/metronic/demo13/rtl/index" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">RTL Version</a>
						</div>
					</div>
					<h5 class="font-weight-bold mb-4 text-center">Demo 14</h5>
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo14.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo15.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo16.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo17.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo18.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo19.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo20.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo21.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo22.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo23.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo24.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo25.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo26.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo27.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo28.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo29.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="{{ asset('/metronic_v7.1.2/media/demos/demo30.jpg') }}" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
