...
<ul class="menu-nav">
    ...
    <li class="menu-item menu-item-submenu {{ isset($cur_uri[4]) && $cur_uri[4] === 'custom' ? 'menu-item-here' : '' }} {{ isset($cur_uri[5]) && $cur_uri[5] === 'apps' ? 'menu-item-here' : '' }} {{ isset($cur_uri[6]) && $cur_uri[6] === 'user' ? 'menu-item-open' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
        ...
        <div class="menu-submenu">
            ...
            <ul class="menu-subnav">
                ...
                <li class="menu-item menu-item-submenu {{ isset($cur_uri[6]) && $cur_uri[6] === 'user' ? 'menu-item-here' : '' }} {{ isset($cur_uri[7]) && $cur_uri[7] === 'list-default' ? 'menu-item-open' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
