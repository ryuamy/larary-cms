...
<div class="d-flex flex-column-fluid">
    <div class="container">
        ...
        <div class="alert alert-custom alert-warning d-flex mb-5" role="alert">
                ...
                <div class="row bx-bulk-action w-100 align-items-center">
                            ...
                            <div class="dataTables_length" id="dataTable_length">
                                <label class="m-0">
                                    <select id="bulk-action-select" name="bulk_action" class="m-0 custom-select custom-select-sm form-control form-control-sm">
                                        ...
                                        @if (check_admin_access($admindata->role_id, 'pages', 'delete') == true)
                    ...
                    <div class="col-sm-12 col-md-7">
                        <div class="d-flex justify-content-end">
                            ...
                            @if ( check_admin_access($admindata->role_id, 'pages', 'add') == true )
