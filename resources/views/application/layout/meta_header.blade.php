...
<meta name="twitter:image" content="{{ isset($meta['image']) ? $meta['image'] : asset('/media/admin/layout/default-featured-img.png') }}">
...
<meta property="og:image" content="{{ isset($meta['image']) ? $meta['image'] : asset('/media/admin/layout/default-featured-img.png') }}">
